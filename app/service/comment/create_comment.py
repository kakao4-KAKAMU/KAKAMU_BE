...
class CommentCreateService:
    def create_comment(self, db: Session, post_id: int, comment_in: CommentCreate, user_id: UUID) -> int:
        ...
        for mention_str in mentions:
            ...
            if target_persona:
                db.add(CommentMention(comment_id=new_comment.id, user_id=target_persona.user_id))
