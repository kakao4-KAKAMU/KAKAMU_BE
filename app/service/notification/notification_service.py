...
from app.schemas.mapper.notification import NotificationMapper
...
class NotificationService:
    ...
    def get_and_read_notifications(
        db: Session, receiver_user_id: UUID, limit: int = 50
        ...
        stmt = (
            select(Notification)
            .where(Notification.receiver_user_id == receiver_user_id)
        ...
        return NotificationListResponse(
            items=[NotificationMapper.to_notification(n) for n in notifications],
