...
def get_posts(
    ...
    return post_read_service.get_posts(db, user_id, cursor, limit)
...
def get_user_posts(
    ...
    """
    user_id = current_user.id if current_user else None
    return post_read_service.get_user_posts(db, target_user_id, user_id, cursor, limit)
...
def get_post_detail(
    ...
    """
    user_id = current_user.id if current_user else None
    return post_read_service.get_post_detail(db, post_id, user_id)