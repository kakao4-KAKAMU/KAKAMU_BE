...
from app.schemas.request.auth import PhoneVerificationRequest
from app.core.firebase import verify_firebase_token
from app.schemas.errors import (
    ERROR_USER_NOT_FOUND,
    ERROR_INVALID_FIREBASE_TOKEN,
...
@router.post(
    ...
    responses={
        400: ERROR_INVALID_FIREBASE_TOKEN,
...
def phone_validation_for_reset_password(
